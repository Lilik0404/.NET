...
{
    public partial class Cautare_contract : Form
    {
        public Cautare_contract()
        {
            InitializeComponent();
        }
        ...
        private void Cautare_contract_Load(object sender, EventArgs e)
        {
        ...
        private void Cautare_contract_Shown(object sender, EventArgs e)
        {
            Loadcombobox();
        }
